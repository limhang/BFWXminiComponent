import $BFDialog from '../../components/Dialog/index.js'
...
Page({
  ...
  open() {
    ...
    const hideDialog = $BFDialog.open({
      title: '三秒后自动关闭',
    ...
    this.timeout = setTimeout(hideDialog.hide, 3000);
    setTimeout(hideDialog.show, 5000);
  },
  confirm() {
    $BFDialog.confirm({
      title: '定制冰激凌',
